...
draw_mana_ = lerp(draw_mana_, obj_player.mana, 0.25);
...
draw_rectangle(x+4, y+4+16, x+91*draw_mana_/obj_player.c_max_mana, y+11+16, false);
draw_set_color(colmp2);
draw_rectangle(x+4, y+8+16, x+91*draw_mana_/obj_player.c_max_mana, y+11+16, false);
